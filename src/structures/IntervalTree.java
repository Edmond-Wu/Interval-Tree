...
public class IntervalTree {
	...
	public static IntervalTreeNode buildTreeNodes(ArrayList<Integer> endPoints) 
	{
		...
		{
			IntervalTreeNode temp = new IntervalTreeNode((float)endPoints.get(i), (float)endPoints.get(i), (float)endPoints.get(i));
			Q.enqueue(temp);
		}
	...
	public void mapIntervalsToTree(ArrayList<Interval> leftSortedIntervals, ArrayList<Interval> rightSortedIntervals) 
	{
		...
		{	
			...
			while (tempLeft != null && added == false)
			{
		...
		{
			boolean added = false;
			while (tempRight != null && added == false)
			{
	...
	{
		int beginA = a.leftEndPoint;
		int endA = a.rightEndPoint;
		int beginB = b.leftEndPoint;
		int endB = b.rightEndPoint;
